...
- Issue with closing edit window after successful edit, issue with not refreshing display after edit (FIXED)

- Issue with alert in edit window, related to closing window (FIXED)
